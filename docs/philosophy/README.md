...
[Home](../../README.md) > [Documentation](../README.md) > Philosophy

Why Knowledge OS exists and what it believes. These documents define the immutable principles that guide every architectural and product decision.
...
| Document | Purpose |
|----------|---------|
| [philosophy.md](philosophy.md) | Core philosophy and immutable principles -- the canonical model as source of truth, storage as implementation detail, AI as a component, and the deterministic pipeline |
| [vision.md](vision.md) | The knowledge problem and the Knowledge OS vision -- why document-centric knowledge management is structurally flawed and what the entity-graph alternative looks like |
| [boundaries.md](boundaries.md) | Goals and non-goals -- what the system is, what it is not, and what it intentionally skips |
